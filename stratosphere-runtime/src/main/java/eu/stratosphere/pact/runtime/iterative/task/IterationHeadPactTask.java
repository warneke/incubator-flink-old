 ...
 * the input, it will send {@link eu.stratosphere.runtime.io.channels.EndOfSuperstepEvent} events to its outputs. It must
 * also be connected to a synchronization task and after each superstep, it will wait
