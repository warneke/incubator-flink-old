...
/**
 * A {@link eu.stratosphere.core.memory.DataInputView} that is backed by a {@link BlockChannelReader},
...
public class ChannelReaderInputView extends AbstractPagedInputView {
	 ...
	 *                  {@link #nextSegment(eu.stratosphere.core.memory.MemorySegment)} method assumes the default header length,
	 ...
	 * @see eu.stratosphere.nephele.services.memorymanager.AbstractPagedInputView#nextSegment(eu.stratosphere.core.memory.MemorySegment)
	 */
	@Override
