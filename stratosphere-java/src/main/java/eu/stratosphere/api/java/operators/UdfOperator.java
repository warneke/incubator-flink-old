...
public interface UdfOperator<O extends UdfOperator<O>> {
	 ...
	 * to the UDF in the {@link eu.stratosphere.api.common.functions.AbstractFunction#open(Configuration)}
	 * method.
	 * 
	 ...
	 * {@link eu.stratosphere.api.common.functions.RuntimeContext#getBroadcastVariable(String)}. The runtime context
	 * itself is available in all UDFs via {@link eu.stratosphere.api.common.functions.AbstractFunction#getRuntimeContext()}.
	 * 
